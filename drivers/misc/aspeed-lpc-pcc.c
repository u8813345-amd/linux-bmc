...
static const uint32_t dma_buf_mask = PCC_DMA_BUFSZ - 1;
...
static irqreturn_t aspeed_pcc_dma_isr(int irq, void *arg)
{
	...
	wptr = ((reg & PCCR6_DMA_CUR_ADDR) - (pcc->dma.addr & PCCR6_DMA_CUR_ADDR)) & dma_buf_mask;
	rptr = pcc->dma.rptr;
